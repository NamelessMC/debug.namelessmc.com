<template>
    <div class="bg-gray-200 dark:bg-gray-900 h-full" v-bind:class="{ 'h-screen': !loaded }">
                    ...
                    <div v-for="module in data.namelessmc.modules" :key="module.name">
                        <div class="section-content-floating">
                            ...
                            <div class="w-full text-center border-b-2 border-blue-400" style="height: 14px;">
                                <span class="bg-gray-100 dark:bg-gray-800 dark:text-gray-300 text-base">&nbsp;Debug Info&nbsp;</span>
                            </div>
        ...
        <footer v-if="loaded" class="md:h-28 bg-yellow-400 dark:bg-indigo-900 text-center">
            <div class="grid md:grid-cols-5 sm:grid-cols-1 md:pt-7 py-6">
                <div></div>
                <div>
                ...
                <div>
                    <button @click="toggleTheme()" class="px-2 h-12 rounded-lg border-2 border-blue-400 dark:border-blue-800 bg-gray-200 dark:bg-gray-900 text-black dark:text-gray-200 font-bold text-sm">Theme: {{ capitalize(this.theme) }}</button>
                </div>
                <div>
                    <h5 class="section-heading">NamelessMC website: <a href="https://namelessmc.com" target="_blank"><span class="font-normal">https://namelessmc.com</span></a></h5>
                    <h5 class="section-heading">Get support: <a href="https://discord.gg/nameless" target="_blank"><span class="font-normal">https://discord.gg/nameless</span></a></h5>
                    <h5 class="section-heading">Made with ❤️</h5>
                </div>
                <div></div>
            </div>
        </footer>
...
export default {
    ...
    methods: {
        ...
        isEmpty(value, code = false) {
            return !value
                    ? '<i class="font-normal text-base dark:text-gray-300">Empty</i>'
                    : code 
                        ? this.asCode(value) 
